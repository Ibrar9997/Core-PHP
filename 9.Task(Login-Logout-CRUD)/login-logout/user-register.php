...
<div class="container col-6">
    ...
    <form action="/Core-PHP/9.Task(Login-Logout-CRUD)/login-logout/user-register.php" method="post">
        <div class="mb-3">
            <label for="username">Username</label>
            <input type="email" class="form-control" id="username" name="username" aria-describedby="emailHelp requied">
        </div>
        <div class="mb-3">
